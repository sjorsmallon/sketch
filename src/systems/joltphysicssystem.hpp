#pragma once
#include "../ecs/ecs.hpp"
#include "../components/joltphysicscomponent.hpp"
...
public:
	...
	{
		Log::log("A body got activated");
	}

	virtual void		OnBodyDeactivated(const BodyID &inBodyID, uint64 inBodyUserData) override
	{
		Log::log("A body went to sleep");
	}
};
...
public:
	...
	JoltPhysicsSystem() :
	 ...
	 {
		RequireComponent<JoltPhysicsComponent>();
		...
		//@NOTE(SMIA): these things should stay alive so I made them static. that's actually horrible but whatever.
